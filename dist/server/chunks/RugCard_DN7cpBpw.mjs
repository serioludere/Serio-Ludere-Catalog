...
var $$Footer = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<footer data-astro-cid-jo6i4kqk> ${!minimal && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result) => renderTemplate`  <a${addAttribute("https://www.serioludere.com", "href")} target="_blank" rel="noopener" data-astro-cid-jo6i4kqk> ${"serioludere.com"} <span class="sr-only" data-astro-cid-jo6i4kqk> (opens in a new tab)</span> </a> <a${addAttribute("https://www.instagram.com/serioluderestudio", "href")} target="_blank" rel="noopener" data-astro-cid-jo6i4kqk> ${"@serioluderestudio"} <span class="sr-only" data-astro-cid-jo6i4kqk> (opens in a new tab)</span> </a> <a${addAttribute(`https://wa.me/525535760978`, "href")} target="_blank" rel="noopener" data-astro-cid-jo6i4kqk> ${"+52 55 3576 0978"} <span class="sr-only" data-astro-cid-jo6i4kqk> (opens in a new tab)</span> </a> ` })}`} <a${addAttribute(`mailto:${STUDIO_EMAIL}`, "href")} data-astro-cid-jo6i4kqk>${STUDIO_EMAIL}</a> <span data-astro-cid-jo6i4kqk>&copy; <span id="yr" data-astro-cid-jo6i4kqk>${year}</span> ${STUDIO_NAME}</span> <span class="fx-note" data-astro-cid-jo6i4kqk>Prices are indicative and convert at an approximate rate.</span> </footer>`;
...
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/components/Wordmark.astro", void 0);
//#endregion
...
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/components/Layout.astro", void 0);
//#endregion
