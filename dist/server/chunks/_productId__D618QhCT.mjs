...
import { i as findCustomer } from "./http_CzR8U5Kz.mjs";
...
import { a as cardView, d as tagSlug, r as activeRugs } from "./view_CcuJ6q8j.mjs";
...
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/components/customer/SpecTable.astro", void 0);
//#endregion
...
var $$ProductId = createComponent(async ($$result, $$props, $$slots) => {
	...
	const fromTag = rawTag && TAG_RE.test(rawTag) ? rawTag : void 0;
	const q = fromTag ? `?tag=${encodeURIComponent(fromTag)}` : "";
	const gridHref = `/${slug}${q}`;
	const hrefForCard = (c) => `/${slug}/${encodeURIComponent(c.id)}${q}`;
	const inTag = (c) => c.tags.some((t) => (t.slug || tagSlug(t.name, catalogue.tags)) === fromTag);
	...
	return renderTemplate`${renderComponent($$result, "PreviewLayout", $$PreviewLayout, {
		...
		"hrefFor": hrefForCard,
		"data-astro-cid-w72pnaip": true
	})} </nav>`} </main>`}${renderComponent($$result, "PreviewFooter", $$PreviewFooter, { "data-astro-cid-w72pnaip": true })} ` })} ${renderScript($$result, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/[slug]/[productId].astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/[slug]/[productId].astro", void 0);
var $$file = "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/[slug]/[productId].astro";
