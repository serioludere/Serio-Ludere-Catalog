...
import { Dt as GOOGLE_OAUTH_CLIENT_ID, Et as GOOGLE_AUTH_MODE, a as getGoogleConnection, at as googleAuthAdvice, c as getSheetIdStore, m as sheetIdIfAny, o as getGoogleStore, ot as missingScopes, st as redirectUriFor } from "./runtime_DeI95MAO.mjs";
import { a as adminRuntime } from "./http_YuZl1CQP.mjs";
import { t as $$AdminLayout } from "./AdminLayout_Bzl8NmWf.mjs";
import { t as $$Button } from "./Button_COMnZ16d.mjs";
import { t as $$Input } from "./Input_CC1j8kWS.mjs";
...
` })} </div> <div id="mSheet" class="msg"></div> ` })}`} </section> ${renderScript($$result, "/home/user/Serio-Ludere-Catalog/src/pages/admin/google.astro?astro&type=script&index=0&lang.ts")}` })}`;
}, "/home/user/Serio-Ludere-Catalog/src/pages/admin/google.astro", void 0);
var $$file = "/home/user/Serio-Ludere-Catalog/src/pages/admin/google.astro";
