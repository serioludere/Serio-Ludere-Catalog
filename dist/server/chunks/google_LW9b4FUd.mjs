...
</p> <div class="row">  <div class="grow field"> <label class="field__label" for="redirectUri">Authorised redirect URI</label> <input id="redirectUri" readonly${addAttribute(redirectUri, "value")}> </div> <button class="btn btn--secondary" id="btnCopyRedirect" type="button">
Copy
...
` })} </div> <div id="mSheet" class="msg"></div> ` })}`} </section> ${renderScript($$result, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/google.astro?astro&type=script&index=0&lang.ts")}` })}`;
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/google.astro", void 0);
var $$file = "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/google.astro";
