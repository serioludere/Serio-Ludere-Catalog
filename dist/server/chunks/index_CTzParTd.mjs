...
import { n as $$Icon, t as $$AdminLayout } from "./AdminLayout_CUeRiiD1.mjs";
import { t as $$Button } from "./Button_DPfEGeVb.mjs";
import { t as $$EmptyState } from "./EmptyState_C3_MM1Zk.mjs";
import { t as $$Input } from "./Input_DU8-HsXq.mjs";
import { n as $$Chips, t as $$RugFields } from "./RugFields_C-bnDH6i.mjs";
import { t as $$FetchModal } from "./FetchModal_9r5vi5ip.mjs";
...
var $$RugRow = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate` ${maybeRenderHead($$result)}<div class="irow" role="row" data-card data-row${addAttribute(rug.id, "data-id")}${addAttribute(slug, "data-collection")}${addAttribute(slugs, "data-collections")}${addAttribute(rug.status, "data-status")}${addAttribute(rug.commitStatus === "pending" ? "photos" : "", "data-attention")}${addAttribute(search, "data-search")}> <div class="irow__line" role="presentation"> <span class="irow__id" role="cell">${rug.id}</span> <span class="irow__title" role="cell" data-cell="name">${rug.name}</span> <span class="irow__collection" role="cell">${rug.collection}</span> <span class="irow__size" role="cell">${size}</span> <span class="irow__price" role="cell">${price}</span> <span class="irow__spacer" role="presentation"></span> <span class="irow__action" role="cell"> ${rug.commitStatus === "pending" && renderTemplate`<button type="button" class="chip retry"${addAttribute(rug.id, "data-retry")}>
Finish photo import
...
var $$RugTable = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<div class="rugtable" role="table" aria-label="Products"> <div class="rugtable__head" role="row"> <span class="irow__id" role="columnheader">ID</span> <span class="irow__title" role="columnheader">Title</span> <span class="irow__collection" role="columnheader">Collection</span> <span class="irow__size" role="columnheader">Size</span> <span class="irow__price" role="columnheader">Price</span>  <span class="irow__spacer" role="presentation"></span> <span class="irow__action" role="columnheader"><span class="sr-only">Actions</span></span> </div> ${rugs.map((rug) => renderTemplate`${renderComponent($$result, "RugRow", $$RugRow, {
		"rug": rug,
