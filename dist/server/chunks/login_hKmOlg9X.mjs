...
import { c as setSessionCookie, l as verifyPassword, o as newSession } from "./auth_Dq6XU5lm.mjs";
import { a as adminRuntime, u as recordAuditEvent } from "./http_friNsH5S.mjs";
import { c as requestIpHash, u as socketAddressOf } from "./api_DdjGbQdl.mjs";
import { n as sanitiseNext } from "./login_DZT9bjRi.mjs";
...
var $$Login = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, {
		...
		"class": "alogin__go",
		"data-astro-cid-xeimgta2": true
	}, { "default": ($$result) => renderTemplate`${locked ? "Locked" : "Enter"}` })} <p class="alogin__fine" data-astro-cid-xeimgta2>Private. Sessions expire after 12 hours idle and 7 days at most.</p> </form> ` })} ${renderScript($$result, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/login.astro", void 0);
var $$file = "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/login.astro";
var $$url = "/admin/login";
//#endregion
