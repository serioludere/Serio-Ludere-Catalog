...
import { t as $$RugFields } from "./RugFields_C-bnDH6i.mjs";
...
Rugs W1:Z1 are blank — run <span class="kbd">npm run sheet:init</span> before adding rugs.
		...
		"nextId": nextId
	})} <script type="application/json" id="admin-data">${unescapeHTML(jsonForScript(data))}<\/script>${renderScript($$result, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/rugs/new.astro?astro&type=script&index=0&lang.ts")}${renderComponent($$result, "FetchModal", $$FetchModal, {
		"id": "fetch-result",
		"title": "Fetching"
	})} ` })}`;
}, "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/rugs/new.astro", void 0);
var $$file = "C:/Users/MD/Desktop/Serio-Ludere-Catalog/src/pages/admin/rugs/new.astro";
