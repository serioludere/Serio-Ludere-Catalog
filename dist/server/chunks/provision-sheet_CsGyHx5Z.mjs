import { A as slugify, B as REFERENCE_COLLECTION_ORDER, C as sizeLabelOf, F as PRODUCT_COLS, H as TABS, I as PRODUCT_HEADER_LABELS, M as SheetsClient, N as HEADERS, P as LEGACY_COLLECTIONS_HEADERS, R as PRODUCT_WIDTH, S as sizeBandOf, V as SETTINGS_SEED, _ as columnLetter, a as getGoogleConnection, c as getSheetIdStore, ht as extractDriveId, l as getTokens, m as sheetIdIfAny, p as resetSheetClient, vt as consoleLogger, w as canonicalCollection, z as RATES_SEED } from "./runtime_BgX1riZH.mjs";
import { t as BADGE_TAG_NAMES } from "./view_BxmrstDZ.mjs";
...
async function provisionSheet(client, info, opts = {}) {
	...
	if (!rugsData?.values?.length && seedMode !== "none") {
		...
		await client.valuesUpdate(`${TABS.products}!A2:AR${n + 1}`, seed.products, "RAW");
	...
	const [check] = await client.batchGet([`${TABS.products}!A1:AR1`]);
